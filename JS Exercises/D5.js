...
console.log(petsCloned.reverse());
...
const newCar = {
  ...
  color: "silver",
  trims: ["sport", "s-line"],
  licensePlate: "AB003YZ",
};

cars.push(newCar);

for (let i = 0; i < cars.lengh; i++) {
  const carObj = cars[i];
...
let value = numericArray[numbers];
while (value !== 32) {
  console.log(value);
  numbers++;
  value = numericArray[numbers];
}
console.log(value);
...
for (let character of charactersArray) {
  if (alphabet[character]) {
    positionArray.push(alphabet[character]);
  }
}
